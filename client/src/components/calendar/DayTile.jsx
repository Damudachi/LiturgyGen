...
export default function DayTile({ iso, day, ticked, current, focusable, onActivate, onKeyDown, tileRef }) {
  ...
  return (
    <button
      ...
      onKeyDown={onKeyDown}
      aria-label={tileAriaLabel(day, iso, { ticked })}
    ...
    >
      ...
      {label && <span className="mt-0.5 line-clamp-2 text-[13px] leading-snug text-muted">{label}</span>}
      {ticked && (
